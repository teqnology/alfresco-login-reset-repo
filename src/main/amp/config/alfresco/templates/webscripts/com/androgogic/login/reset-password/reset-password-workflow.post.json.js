...
function isArgMissing(json, arg, message) {
...
function main(){
    ...
    if (isArgMissing(json, "password", msg.get("error.noPassword"))) return;
    if (isArgMissing(json, "username", msg.get("error.noUser"))) return;
    if (isArgMissing(json, "activiti", msg.get("error.noRequest"))) return;
    if (isArgMissing(json, "key", msg.get("error.noKey"))) return;
